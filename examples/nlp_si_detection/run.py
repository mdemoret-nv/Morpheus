...
@click.option(
    ...
    default="examples/data/pcap_dump.jsonlines",
    required=True,
    help="Input filepath",
)
@click.option(
...
@click.option("--server_url", required=True, default="localhost:8001", help="Tritonserver url")
@click.option(
    "--file_type",
...
def run_pipeline(
    ...
    # Set source stage
    pipeline.set_source(source_stage)
    ...
    print("total lines: {}".format(source_stage.input_count))
