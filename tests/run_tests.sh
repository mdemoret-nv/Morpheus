...
if [ -n "${MORPHEUS_RUN_SLOW_TESTS}" ]; then
    ...
    pytest ${TEST_DIR}/test_filter_detections_stage_pipe.py::TestFilterDetectionsStagePipe::test_filter_pipe_cpp
    pytest ${TEST_DIR}/test_filter_detections_stage_pipe.py::TestFilterDetectionsStagePipe::test_filter_pipe_no_cpp
